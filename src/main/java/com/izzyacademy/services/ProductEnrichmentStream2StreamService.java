...
public class ProductEnrichmentStream2StreamService implements StreamMicroService {
    ...
    private static final String PRODUCT_ENRICHED2_TOPIC = "estreams64.ecommerce.products_enriched1";

    public ProductEnrichmentStream2StreamService()
    {
    ...
    public static estreams64.ecommerce.product_enriched.Value joiner(estreams64.ecommerce.products.Value product, estreams64.ecommerce.product_details.Value details) {
