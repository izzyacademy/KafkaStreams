...
public class KStreamService implements StreamMicroService {

    private static final String CLIENT_ID = "64";
    private static final String APP_ID = KStreamService.class.getName();
    ...
    public void run() {
        ...
        KStream<Integer, Value> customersKStream = builder.stream(INPUT_TOPIC, Consumed.with(Serdes.Integer(), customerSerde));

        customersKStream.print(Printed.toSysOut());
